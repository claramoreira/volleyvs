...
public class FirstPlayerService implements PlayerService {
	...
	public List<Player> findAll() {
		Player p1 = new Player(1L, "Gabi", 95, Condition.GOOD, Position.PONTEIRA1, 1.80, 3.05, 2.89, 1.80, 51.92, 13.1,
				10.9, 0.8, 17.4, 1.52, 14.32);
		Player p2 = new Player(2L, "Natalia", 80, Condition.BAD, Position.PONTEIRA2, 1.86, 3.11, 2.95, 3.2, 48.02, 14.9,
		...
		Player p4 = new Player(4L, "Macris", 84, Condition.EXCELLENT, Position.LEVANTADORA, 1.78, 2.92, 2.75, 1.11,
				34.62, 14.04, 6.4, 0.63, 0.60, 0.53, 7.0);
		Player p5 = new Player(5L, "Mara", 81, Condition.AWFUL, Position.CENTRAL1, 1.90, 3.10, 2.97, 7.0, 41.20, 14.81,
				2.0, 0.2, 5.0, 2.01, 1.2);
		Player p6 = new Player(6L, "Gattaz", 88, Condition.NEUTRAL, Position.CENTRAL2, 1.93, 3.15, 2.99, 4.58, 59.15,
