...
public class SecondPlayerService implements PlayerService {
	...
	public List<Player> findAll() {
		Player p1 = new Player(8L, "Daroit", 80, Condition.GOOD, Position.PONTEIRA, 1.84, 2.90, 2.80, 0.99, 42.82, 8.11,
				10.1, 0.75, 15.32, 1.01, 4.97);
		Player p2 = new Player(9L, "Bruna Honorio", 77, Condition.BAD, Position.PONTEIRA, 1.81, 3.10, 2.92, 4.20, 39.93,
		...
		Player p5 = new Player(12L, "Carolana", 90, Condition.AWFUL, Position.CENTRAL, 1.83, 3.16, 3.09, 3.22, 34.92,
				25.1, 6.9, 3.5, 4.7, 7.88, 2.21);
		Player p6 = new Player(13L, "Thaisa", 89, Condition.NEUTRAL, Position.CENTRAL, 1.96, 3.20, 3.15, 4.51, 48.31,
